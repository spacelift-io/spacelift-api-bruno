...
const CATEGORIES = {
  ...
  suggestions: {
    ...
    operations: [
      "apiKeySessionsWithAccessToSpaceSuggestions",
      "apiKeysWithAccessToSpaceSuggestions",
      "openTofuMigrateSuggestions",
      "openTofuMigrationQueueSearchSuggestions",
      ...
      "searchRunsSuggestions",
      "searchScansSuggestions",
      "searchSpaceContextsSuggestions",
      "searchSpacePoliciesSuggestions",
      "searchSpacesSuggestions",
      ...
      "stacksWithAccessToSpaceSuggestions",
      "userGroupsWithAccessToSpaceSuggestions",
      "userSessionsWithAccessToSpaceSuggestions",
      "usersWithAccessToSpaceSuggestions",
    ],
  },
  notifications: {
  ...
  intent: {
    ...
    operations: [
      ...
      "intentModuleResources",
      "intentPolicyInputSchema",
      "intentProject",
      "intentProjectActivate",
      "intentProjectActive",
      "intentProjectAttachWorkerPool",
      "intentProjectConfigAdd",
      "intentProjectConfigDelete",
      "intentProjectConfigUpdate",
      "intentProjectCreate",
      "intentProjectDelete",
      "intentProjectDetachWorkerPool",
      "intentProjectDisable",
      "intentProjectEnable",
      "intentProjectUnlock",
      "intentProjectUpdate",
      "intentProjects",
      "intentResourceDependencyAdd",
      "intentResourceDependencyRemove",
      "intentResourceOperationReview",
      "intentResourceStateEject",
