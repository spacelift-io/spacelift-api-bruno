...
const CATEGORIES = {
  ...
  "user-guide": {
    ...
    operations: [
      ...
      "userGuideCertificationList",
      "userGuideCertificationUpdate",
      "userGuideChapter",
      "userGuideChapters",
      "userGuideComplete",
      "userGuideGroup",
  ...
  "account-settings": {
    ...
    operations: [
      ...
      "accountSetInfraAssistantEnabled",
      "accountSetOAuthRedirectAllowlist",
      ...
      "hasAnsibleStacks",
      "hasSSO",
      "infraAssistantBuildModeEnabled",
      "infraAssistantEnabled",
      "latestTermsAndConditionsVersionAI",
      "markedForDeletion",
      "oauthRedirectAllowedHosts",
      "runLogRetentionDays",
      "spaceliftIntelligenceEnabled",
      "spaceliftIntelligenceTermsAccepted",
      "spaceliftIntelligenceTermsLatestVersion",
  ...
  infrastructure: {
    ...
    operations: ["installationId", "messageQueueStats", "policyRuntime"],
  },
  forms: {
    folder: "Forms",
